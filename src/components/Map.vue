<template>
     ...
     <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto flex ">
            <div
                class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative flex-wrap">
                <!-- leaflet-->
            ...
            <ContactUsPlugin class="" v-if="showContactUs"/>
