<template>
  <div class="notification-manager">
    ...
    <transition name="slide-down">
      ...
      >
        <div class="glass-strong p-6 rounded-2xl shadow-2xl border border-sky-500/30">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ $t('notification.enable_title') || 'Engedélyezed az értesítéseket?' }}</h3>
              ...
              <div class="flex gap-3">
                <button
                  ...
                  class="btn-primary flex-1 glass-btn px-4 py-2 text-white font-semibold rounded-full transition-all duration-300 disabled:opacity-50"
                >
                ...
                <button
                  @click="dismissBanner"
                  class="btn-secondary btn-ghost-glass px-4 py-2 font-semibold"
                >
            ...
            <button @click="closeBanner" class="text-gray-400 hover:text-sky-600 dark:hover:text-sky-300 transition-colors">
    ...
    <div class="notification-settings" v-if="showSettings">
      <div class="settings-card p-4 glass-card rounded-lg">
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            @click="subscribe"
            class="px-4 py-2 glass-btn text-white rounded-lg text-sm font-medium transition-colors"
          >
