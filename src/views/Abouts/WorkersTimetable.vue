      ...
      x: 0,
        ...
        this.headers= [
                { title: this.$t("name"), align: 'start', sortable: false, key: 'name',width: '200px' },
                 { title: this.$t("time_table"), align: 'start', key: 'img',cellRenderer:function(params) {
                        
                      } }];
        else 
        this.headers= [
                { title: this.$t("name"), align: 'start', sortable: false, key: 'name',width: '200px' },
                 { title: this.$t("time_table"), align: 'start', key: 'img', width: '200px', cellRenderer:function(params) {
